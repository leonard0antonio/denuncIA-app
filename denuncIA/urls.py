...
urlpatterns = [
    ...
    path("denuncias/agrupadas/", views.DenunciasAgrupadasView.as_view(), name="denuncia-agrupada"),
    ...
    path("gestor/register/", views.CreateGestorPublicoView.as_view(), name="gestor-register"),
